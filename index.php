...
session_start();
/**
 * Author : Archime S. ZULU
 * Email : archimezulu@gmail.com
 * GitHub : https://github.com/Archime-sidiz/
 * @Copyright 2023
 */
...
<body>
    <div id="app">
        <nav class="navbar justify-content-center navbar-light bg-success">
            <a class="navbar-brand text-white" href="#">
            SECURITE INFORMATIQUE LABORATOIRE N°1
            </a>
        </nav>
        <div class="container">
            <div class="card mt-1">
                <div class="card-body">
                    <h5 class="card-title">Chiffrement Feistel Cipher</h5>
                    <div class="row">
                        <div class="col-md-6">
                            <form class="form" action="" method="post">
                                ...
                                <span class="text-success">RESULTAT : <?= (isset($stringKeysOne)) ? "Prémière clé = " . $stringKeysOne : '' ?> <?= (isset($stringKeysTwo)) ? "Clé deuxième = " . $stringKeysTwo : '' ?></span><br />
                                <button name="keySubmit" type="submit" class="btn-sm btn btn-success">Générer</button>
                            </form>
                            <form class="form" action="" method="post">
                                ...
                                <span class="text-success">RESULTAT : <?= isset($_POST['encryptSubmit']) ? 'La valeur chiffrer est : ' . $stringData : '' ?></span><br />
                                <button name="encryptSubmit" type="submit" <?= (isset($_SESSION['keys']) ? '' : 'disabled') ?> class="btn-sm btn btn-success">Chiffrement</button>
                            </form>
                        </div>
                        <div class="col-md-6">
                            <form action="" method="post">
                                ...
                                <span class="text-success">RESULTAT : <?= isset($_POST['decryptSend']) ? 'La valeur déchiffrer est : ' . $stringDecrypt : '' ?></span><br />
                                <button <?= (isset($_SESSION['keys']) ? '' : 'disabled') ?> name="decryptSend" type="submit" class="btn-sm btn btn-success">Déchiffrer</button>
                            </form>
                            ...
                            Copyright © 2023, SIDIFUKA ZULU Archime L2 Génie Informatique
                        </div>
                    </div>
                </div>
            </div>
